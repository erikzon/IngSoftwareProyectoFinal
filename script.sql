...
ALTER TABLE estaciones ADD CONSTRAINT FK_estaciones_municipalidades FOREIGN KEY (ID_MUNICIPALIDAD) REFERENCES municipalidades (ID_MUNICIPALIDAD) ON DELETE CASCADE;
...
ALTER TABLE accesos ADD CONSTRAINT FK_accesos_estaciones FOREIGN KEY (ID_ESTACION) REFERENCES estaciones (ID_ESTACION) ON DELETE CASCADE;
...
ALTER TABLE buses ADD CONSTRAINT FK_buses_lineas FOREIGN KEY (ID_LINEA) REFERENCES lineas (ID_LINEA) ON DELETE CASCADE;
ALTER TABLE buses ADD CONSTRAINT FK_buses_parqueos FOREIGN KEY (ID_PARQUEO) REFERENCES parqueos (ID_PARQUEO) ON DELETE CASCADE;
...
ALTER TABLE empleados ADD CONSTRAINT FK_empleados_puestos FOREIGN KEY (ID_PUESTO) REFERENCES puestos (ID_PUESTO) ON DELETE CASCADE;
...
ALTER TABLE estacion_linea ADD CONSTRAINT FK_estacion_linea_estaciones FOREIGN KEY (ID_ESTACION) REFERENCES estaciones (ID_ESTACION) ON DELETE CASCADE;
ALTER TABLE estacion_linea ADD CONSTRAINT FK_estacion_linea_lineas FOREIGN KEY (ID_LINEA) REFERENCES lineas (ID_LINEA) ON DELETE CASCADE;
...
ALTER TABLE turnos_bus ADD CONSTRAINT FK_turnos_bus_empleados FOREIGN KEY (ID_EMPLEADO) REFERENCES empleados (ID_EMPLEADO) ON DELETE CASCADE;
ALTER TABLE turnos_bus ADD CONSTRAINT FK_turnos_bus_buses FOREIGN KEY (ID_BUS) REFERENCES buses (ID_BUS) ON DELETE CASCADE;
